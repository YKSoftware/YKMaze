namespace YKMaze.ViewModels
{
    ...
    public class MainViewModel : ViewModelBase
    {
        ...
        private DelegateCommand _randomCreateCommand;
        public DelegateCommand RandomCreateCommand
        {
            get
            {
                return _randomCreateCommand ?? (_randomCreateCommand = new DelegateCommand(_ =>
                {
                    var mapInfo = MapItems.RandomStage(_width, _height, ++StageNumber);
                    DebugData = mapInfo.MapData;
        ...
        public int StageNumber
        {
            ...
            set { SetProperty(ref _stageNumber, value); }
        }

        public IReadOnlyList<IReadOnlyList<bool>> DebugData { get; private set; }
    }
}
