namespace YKMaze.Models
{
    ...
    public class MapInfo
    {
        ...
        public MapInfo()
        {
            GoalBonus = new ItemInfo()
            {
                Name = "ステージボーナス[20]",
                Value = 20,
                PickupMessage = "ステージボーナスで体力が少し回復した。",
            };
        }
        ...
        /// ゴールボーナスを取得または設定します。
        /// </summary>
        public ItemInfo GoalBonus { get; set; }
        ...
        private IReadOnlyList<IReadOnlyList<bool>> _mapData = new List<List<bool>>();
        /// <summary>
        /// 迷路データを取得または設定します。
        ...
        private IReadOnlyList<KeyValuePair<MapPoint, ItemInfo>> _itemData = new List<KeyValuePair<MapPoint, ItemInfo>>();
        /// <summary>
        /// アイテムデータを取得または設定します。
        /// </summary>
        public IReadOnlyList<KeyValuePair<MapPoint, ItemInfo>> ItemData
        {
        ...
        private MapStatus GetStatus(int stop, int left, int right)
        {
            if (stop < 0)
            {
                ...
                if (left < 0)
                {
                    ...
                    {
                        return MapStatus.Stop_None_Left_None_Right_Pre0_Pre2;
                    }
                }
                else if (left == 0)
                {
                    ...
                    {
                        return MapStatus.Stop_None_Left_Pre0_Right_Pre0_Pre2;
                    }
                }
                else if (left == 1)
                {
                    ...
                    {
                        return MapStatus.Stop_None_Left_Pre1_Right_Pre0_Pre2;
                    }
                }
                else if (left == 2)
                {
                    ...
                    {
                        return MapStatus.Stop_None_Left_Pre2_Right_Pre0_Pre2;
                    }
                }
                else
                {
                    if (right < 0)
                    {
                        return MapStatus.Stop_None_Left_Pre0_Pre2_Right_None;
                    }
                    else if (right == 0)
                    {
                        return MapStatus.Stop_None_Left_Pre0_Pre2_Right_Pre0;
                    }
                    else if (right == 1)
                    {
                        return MapStatus.Stop_None_Left_Pre0_Pre2_Right_Pre1;
                    }
                    else if (right == 2)
                    {
                        return MapStatus.Stop_None_Left_Pre0_Pre2_Right_Pre2;
                    }
                    else
                    {
                        return MapStatus.Stop_None_Left_Pre0_Pre2_Right_Pre0_Pre2;
                    }
                }
            }
            else if (stop == 0)
